...
def render_app_sidebar(
    *,
    ...
    st.sidebar.page_link("pages/6_Command_Dashboard.py", label="Command Dashboard")
    st.sidebar.page_link("pages/5_Action_Center.py", label="Action Center")
    st.sidebar.page_link("pages/10_Alert_Center.py", label="Alert Center")

    st.sidebar.markdown("---")
    st.sidebar.markdown("## 📊 ANALYSIS")
    st.sidebar.page_link("pages/3_Insights.py", label="Insights")
    st.sidebar.page_link("pages/4_Forecast.py", label="Forecast")
    st.sidebar.page_link("pages/2_History.py", label="History")
    st.sidebar.page_link("pages/11_Historical_Replay.py", label="Historical Replay")
    st.sidebar.page_link("pages/12_Stress_Test.py", label="Stress Test")

    st.sidebar.markdown("---")
    st.sidebar.markdown("## 🌍 PUBLIC & INFO")
    st.sidebar.page_link("pages/8_Public_Advisory.py", label="Public Advisory")
    st.sidebar.page_link("pages/9_Resources_Map.py", label="Resources Map")
    st.sidebar.page_link("pages/7_Methodology_Research.py", label="Methodology / Research")
